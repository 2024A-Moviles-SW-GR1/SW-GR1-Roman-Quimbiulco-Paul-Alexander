...
class FRecyclerViewAdaptadorGrupo(
    private val contexto: MateriaDetail,
    private var lista: List<Grupo>,
    private val recyclerView: RecyclerView
) : RecyclerView.Adapter<FRecyclerViewAdaptadorGrupo.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
            ...
            holder.nombreTextView.text = grupoActual.nombre
